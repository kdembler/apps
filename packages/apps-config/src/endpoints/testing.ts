...
export const testChains: Omit<EndpointOption, 'teleport'>[] = [
  {
    info: 'joy-testnet-ephesus',
    providers: {
      'freakstatic': 'wss://65.108.208.60.nip.io/ws-rpc',
      'klaudiusz': 'wss://65.109.99.174.nip.io/ws-rpc'
    },
    text: 'Ephesus Testnet',
    ui: {
      color: '#008a16',
  ...
  {
    info: 'joy-luxor-ephesus',
    providers: {
      'freakstatic': 'wss://168.119.228.195.nip.io/ws-rpc',
    },
    text: 'Luxor Testnet',
    ui: {
      color: '#008a16',
